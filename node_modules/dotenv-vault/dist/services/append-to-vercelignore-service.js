...
exports.AppendToVercelignoreService = void 0;
...
class AppendToVercelignoreService {
    ...
    missing() {
        return !(0, fs_1.existsSync)(this.vercelignore);
    }
    append(str) {
        (0, fs_1.appendFileSync)(this.vercelignore, str);
    }
    touch() {
        (0, fs_1.writeFileSync)(this.vercelignore, '');
    }
    read() {
        return (0, fs_1.readFileSync)(this.vercelignore, 'utf8');
    }
    async run() {
        let envExists = false;
...
exports.AppendToVercelignoreService = AppendToVercelignoreService;
